...
import com.example.foodstore.adapter.MessageAdapter;
...
import com.example.foodstore.notification.Data;
import com.example.foodstore.notification.Sender;
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(user.getTokenstore().equalsIgnoreCase(mUser.getUid())) {
                        if (notify) {
                            ...
                            notify = false;
                            Toast.makeText(ChatActivity.this, "Thất Công", Toast.LENGTH_SHORT).show();
